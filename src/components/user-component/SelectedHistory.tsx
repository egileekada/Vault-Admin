...
export default function SelectedHistory(props: any) {
    return (
        <div className='w-full p-8 mb-6' >
            <div style={{backgroundColor: '#F5F5F5'}}  className='w-full flex py-8 px-6 items-center mb-8 ' >
                ...
                <div className='w-auto ml-auto' >  
                    <p style={{color: '#979797'}} className='font-Inter-Medium text-right text-sm '>ID</p> 
                    <p style={{color: '#002343'}} className='font-Inter-Regular text-base ml-1'>DD3400000</p> 
                </div>
            </div>
            <div className='w-full grid-cols-3 grid gap-14 mt-6' >
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >AMOUNT</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >₦ 423,345.00</p>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >START DATE</p>
                    <div className='flex items-center mt-2' >
                        ...
                        <p style={{color: '#002343'}} className='font-Inter-Regular text-sm ml-1'>12, Jun 2021</p>
                    </div>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >DUE DATE</p>
                    <div className='flex items-center mt-2' >
                        <svg width="17" height="17" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.00033 12.8333C10.222 12.8333 12.8337 10.2216 12.8337 6.99994C12.8337 3.77828 10.222 1.16661 7.00033 1.16661C3.77866 1.16661 1.16699 3.77828 1.16699 6.99994C1.16699 10.2216 3.77866 12.8333 7.00033 12.8333Z" stroke="#1F1F1F"/>
                            <path d="M7 3.79166V7L8.75 8.75" stroke="#1F1F1F" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >SAVINGS TYPE</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >Joint Savings</p>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >PATTERN</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >₦ 40,000 / Daily</p>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >FIXED</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >Yes</p>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >INTEREST RATE</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >5.0% P.A</p>
                </div>
                <div className='w-auto' >
                    <p style={{color: '#979797'}} className=' font-Inter-Bold text-xs ' >INTEREST GAINED</p>
                    <p style={{color: '#002343'}} className=' font-Inter-Medium text-sm mt-2 ' >₦ 40,000</p>
                </div>
            </div>
        </div>
    )
